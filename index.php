<!DOCTYPE html>
	...
	<body>
		...
		<main>
			...
			<p><b>Technology</b>:
				<ul>
				<li><b>MacPro Desktop</b> (work: design studio)</li>
				<li><b>MacBook Pro</b> (home: newer model and updated IOS, external hard drive)</li>
				<li><b>iPhone6s or higher</b> (mobile: International data plan as Jose' travels a handful of times a year for work, was born in Montreal and has lived internationally for both school and work)</li>
		...
		<h3 align="left">Interaction Flow: Specific Steps</h3>
				<ol>
					...
					<li>Jos&eacute; submits all applicant requirements to said employer email</li>
